...
Переменные, условия, циклы, функции, аргументы, запуск. Текстовые фильтры и `|` — уроки **Потоки** и **Терминал**.
...
## Текстовые фильтры в скриптах

Флаги **`ls`**, разовые замены **`sed`/`awk`** и конвейеры — в уроках **Терминал** и **Потоки и обработка данных**; здесь используй их внутри скриптов так же, как в интерактивной оболочке.